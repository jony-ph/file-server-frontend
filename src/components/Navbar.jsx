...
const NavigationBar = ({ navbarFlag }) => {

  const [width, setWidth] = useState(window.innerWidth);

  const homeIcon = (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" width={30}>
    ...
    <Navbar bg="dark" variant="dark" fixed={ width < 1000 ? 'bottom' : 'top'}>
      <Container>
        <Nav className="m-auto">
          ...
          <div className="mx-4 my-2">
            <NavLink to="/files" className={ ({isActive}) => isActive ? styles.active : styles.link }>
